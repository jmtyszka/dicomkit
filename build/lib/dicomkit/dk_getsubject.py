        ...
        for (status, identifier) in responses:
            ...
            if status:
                ...
                if status.Status == 0xFF00:
                    ...
                    # At study_row and series UIDs to collection
...
def retrieve_series(remote_addr, remote_port, uids, debug=False):
    """
    Retrieve study_row/series specified in UID info list from remote SCP
    ...
    :param remote_port: int
        Remote SCP port
    :param uids: list
        List of tuples containing patient/study_row/series UID info
    :param debug: bool
        Debug flag
    :return:
    """
    ...
    # Loop over all patient/study_row/series UID info
    for uid in uids:
